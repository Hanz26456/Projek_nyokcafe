...
//        String kode = txt_kodebarang.getText();
        ...
        String query = "INSERT INTO `tbl_produk` (id_produk, `nama_produk`, `haarga_produk`, `stok`, `tanggal`) "
    ...
    private void hapusData(){
        ...
        String query = "DELETE FROM `tbl_produk` WHERE `tbl_produk`.`id_produk` = "+kode+" ";
        try{
            PreparedStatement ps = (PreparedStatement) connect.prepareStatement(query);
            ps.execute();
    ...
    private void editData(){
        ...
        String query = "UPDATE `tbl_produk` SET `nama_produk` = '"+nama+"', `haarga_produk` = '"+harga+"', `stok` = '"+stok+"', `tanggal` = '"+tanggal+"' "
                + "WHERE `tbl_produk`.`id_produk` = '"+kode+"';";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("DATA MENU PRODUK NYOK COFFEE");
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/attachment.png"))); // NOI18N
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try{
            ...
            ResultSet res = statement.executeQuery("SELECT tbl_produk.id_produk,tbl_produk.nama_produk,tbl_produk.haarga_produk,tbl_produk.stok,tbl_produk.tanggal FROM tbl_produk  ");
            dirr = reportfile.getCanonicalPath()+"/src/report/";
            JasperDesign design = JRXmlLoader.load(dirr+"laporanproduk.jrxml");
            ...
            JOptionPane.showMessageDialog(table_barang1, e);
        }
