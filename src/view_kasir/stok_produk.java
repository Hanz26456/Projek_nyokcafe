...
public class stok_produk extends javax.swing.JFrame {
        ...
        try{
            ...
            while (rslt.next()){
                //menampung data sementara
                    ...
                    String id = rslt.getString("id_produk");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stok_produk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
